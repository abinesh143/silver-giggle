        ...
        <div className="h-full px-6 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <Link href="/" className="flex items-center justify-center">
            <img
              ...
              alt="App Maker Pro"
            />
            <span className="ms-1 text-2xl text-[#FE5000] font-semibold">APP AI PRO</span>
          </Link>
          <ul className="space-y-4 font-medium pt-6 text-xl">
            ...
            <li>
              <div
                className={`${
                  activeTab === "publish" ? "bg-blue-500" : "hover:bg-gray-100"
                } flex items-center p-2 text-gray-900 rounded-lg dark:text-white cursor-pointer dark:hover:bg-gray-700 group`}
                onClick={() => setActiveTab("publish")}
              >
                <svg
                  className={`${
                    activeTab === "publish" ? "text-gray-900" : "text-gray-500"
                  } w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
            ...
            <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
              <li>
                <div
                  className={`${
                    activeTab === "pro" ? "bg-blue-500" : "hover:bg-gray-100"
                  } flex items-center p-2 text-gray-900 rounded-lg dark:text-white cursor-pointer dark:hover:bg-gray-700 group`}
                  onClick={() => setActiveTab("pro")}
                >
                  <svg
                    className={`${
                      activeTab === "pro" ? "text-gray-900" : "text-gray-500"
                    } w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
              ...
              <li>
                <div
                  className={`${
                    activeTab === "review" ? "bg-blue-500" : "hover:bg-gray-100"
                  } flex items-center p-2 text-gray-900 rounded-lg dark:text-white cursor-pointer dark:hover:bg-gray-700 group`}
                  onClick={() => setActiveTab("review")}
                >
                  <svg
                    className={`${
                      activeTab === "review" ? "text-gray-900" : "text-gray-500"
                    } w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
              ...
              <li>
                <div
                  className={`${
                    activeTab === "help" ? "bg-blue-500" : "hover:bg-gray-100"
                  } flex items-center p-2 text-gray-900 rounded-lg dark:text-white cursor-pointer dark:hover:bg-gray-700 group`}
                  onClick={() => setActiveTab("help")}
                >
                  <svg
                    className={`${
                      activeTab === "help" ? "text-gray-900" : "text-gray-500"
                    } w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
              ...
              <li>
                ...
                >
                  <svg
                    className={`${
                      activeTab === "logout" ? "text-gray-900" : "text-gray-500"
                    } w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
