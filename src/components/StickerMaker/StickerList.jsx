...
const StickerList = () => {
    ...
    return <main className="px-4 sm:px-8 sm:py-4 max-lg:my-4 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {
                stickers.map((s, index) => <div key={`sticker-${index}`} class="max-w-sm p-2.5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
