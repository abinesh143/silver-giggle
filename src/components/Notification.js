      ...
      <div className="p-4 sm:p-8 bg-[#F9F9F9] lg:rounded-2xl">
        ...
        {isPaused ? (
          <>
            ...
            <div className="absolute w-[calc(100vw-360px)] max-lg:top-0 h-[calc(100vh-240px)] overflow-hidden z-40 flex flex-col justify-center items-center text-black">
              <div className="max-sm:fixed max-sm:bottom-0 max-sm:rounded-t-[24px] flex flex-col items-center sm:rounded-[32px] bg-white w-full sm:w-[80%] lg:w-[50%] xl:w-[40%] p-8">
                <Image
                ...
                <button className="bg-black text-xs sm:text-base lg:text-sm xl:text-base font-medium rounded-lg sm:rounded-xl text-white py-2 px-8 xl:py-3">
                  Upgrade to Premium
                </button>
              </div>
            </div>
        ...
        <section className="flex h-[calc(100vh-224px)]">
          <div className="basis-1/2">
            <div className="flex">
              <div className="basis-2/5 relative bg-[#E0F2FF] rounded-t-[24px] sm:rounded-t-[32px] px-4 sm:px-10 lg:px-6 xl:px-10">
                ...
                <div className="text-[#4983AB] text-xs sm:text-base lg:text-lg font-semibold py-3 sm:py-4">
                  Notification
                </div>
              </div>
            </div>
